...
(function(){
    ...
    app.factory('searchDataService', ["$http", "$rootScope", function($http, $rootScope, query) {
        ...
        function prepForBroadcast(query) {
            ...
            recentMedia(geoid, 1388880000, 3);
        }
